...
//header("Access-Control-Allow-Headers", "Origin, X-Requested-With, Accept, Authorization");
...
//http://localhost/innovative_frontend/weather.php?command=search&keyword=london
